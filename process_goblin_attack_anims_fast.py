...
def make_transparent(img):
    ...
    # Quick transparency using internal operations
    # Create mask where pixels are near-white or near-black
    from PIL import ImageMath
    r, g, b, a = img.split()
    
    # We want to keep pixels that are NOT (R>240 & G>240 & B>240) AND NOT (R<20 & G<20 & B<20)
    # So drop pixels where (r>240 and g>240 and b>240) or (r<20 and g<20 and b<20)
    
    # Just do a simplistic pixel access, but pre-allocate a list.
    data = img.getdata()
...
def process_attack_grid(grid_path, target_size=(128, 128)):
    ...
    # Could be 2x2 or 4x1 or 1x4... we guess 2x2 
    ...
    for i, (x, y) in enumerate(positions):
        ...
        if bbox:
            ...
            sw, sh = sprite.size
            # scale down to target size keeping ratio
