...
func _build_affix_label(delta_stats: Dictionary) -> String:
	...
	var name_map := {
		...
		"jump_velocity_add": "of Launch",
		"air_control_mult": "of Drift",
		"dash_speed_add": "of Burst",
		"dash_distance_add": "of the Comet",
		"dash_cooldown_mult": "of Resetting",
		"grapple_range_add": "of Reach",
		"grapple_pull_speed_mult": "of the Hook",
		"jet_fuel_add": "of Reserve",
		"jet_thrust_add": "of Lift",
		"jet_recharge_mult": "of Refueling",
		"jet_recharge_rate_mult": "of Recovery",
